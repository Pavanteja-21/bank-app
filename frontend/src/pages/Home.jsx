    ...
    return (
        <div className="text-center py-20">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Modern Banking</span>{' '}
                <span className="block text-indigo-600 xl:inline">for Everyone</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                Manage your accounts, transfers, and cards with ease and security. Join thousands of users today.
            </p>
